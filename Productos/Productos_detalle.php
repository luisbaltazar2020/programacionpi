...
<html>
    ...
    <?php
            ...
            $con = conecta();
            $id = $_REQUEST['id'];
            $sql ="SELECT nombre,codigo,descripcion,costo,stock,archivo_n FROM `productos` WHERE id=$id;";
            $res = $con->query($sql);
            $row=$res->fetch_array();
    ...
    <div class='Menup'>
        ...
        <div class="tabla">
            ...
            <div class="correo">Descripcion</div>
            <div class="fila">Costo</div>
            <div class="fila">Stock</div>
